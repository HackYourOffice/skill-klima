...
class KlimaSkill(MycroftSkill):
    ...
    @intent_handler(IntentBuilder("SetTemperaturIntent").require("setTemperature").require("temperature").require("grad").require("room").build())
    ...
    def handle_penis_intent(self, message):
